...
Single import-side-effect module. The launch script does
    ...
    import training_m5_1.src.registry  # populates DATASET_REGISTRY, PROCESSOR_REGISTRY, ENV_REGISTRY
...
from training_m5_1.src.datasets.search_r1 import SearchR1Dataset
from training_m5_1.src.processors.search_r1 import search_r1_processor

ENV_NAME = "search_r1"
DATASET_NAME = "search_r1"
PROCESSOR_NAME = "search_r1_processor"
ENV_ACTOR_FQN = "training_m5_1.src.environments.search_r1_env.SearchR1Environment"
