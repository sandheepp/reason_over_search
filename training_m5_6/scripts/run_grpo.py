...
Usage (delegates argv to the upstream parser, including Hydra overrides):
    ...
    training_m5_6/scripts/run_grpo.py \\
        --config=training_m5_6/configs/m5_6_research_paper.yaml \\
...
def _setup_paths() -> None:
    """Make `training_m5_6.src` and `examples.run_grpo` importable."""
    paths = (REPO_ROOT, REPO_ROOT / "training_m5_6" / "nemo_rl")
    for p in paths:
        sp = str(p)
...
def main() -> None:
    ...
    import training_m5_6.src.registry  # noqa: F401
